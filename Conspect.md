...
>1. git branch __name branch__ - создает новую ветку 
>2. git branch - показывает существующие ветки.
>3. git branch -D __name branch__ - удаление ветки.
>4. git merge __name branch__ - находясь в ветке с которой нужно произвести слияние.
>5. git log --author=' ' - показывает коммиты указанного автора.
>6. git log -S '' - показывает когда была добавлена строка.
>7. git reset --hard HEAD~1 - удаляет последний коммит.
